...
classesFile = r'C:\Users\Tim\IRP\Main\version 2.0\YOLOv3\COCO_YOLOv3\coco_classes.txt'
classNames = []
with open(classesFile,'rt') as f:
    classNames = f.read().rstrip('\n').split('\n')

modelConfiguration = r'C:\Users\Tim\IRP\Main\version 2.0\YOLOv3\COCO_YOLOv3\yolov3.cfg'
modelWeights = r'C:\Users\Tim\IRP\Main\version 2.0\YOLOv3\COCO_YOLOv3\yolov3_weights.weights'
